...
public class ServiceRestarter extends AbstractPolicy {
    ...
    public static final BasicNotificationSensor<HASensors.FailureDescriptor> ENTITY_RESTART_FAILED = new BasicNotificationSensor<HASensors.FailureDescriptor>(
            HASensors.FailureDescriptor.class, "ha.entityFailed.restart", "Indicates that an entity restart attempt has failed");
    ...
    protected void onRestartFailed(String msg) {
        ...
        entity.emit(ENTITY_RESTART_FAILED, new HASensors.FailureDescriptor(entity, msg));
    }
}
