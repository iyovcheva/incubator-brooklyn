...
public abstract class AbstractFailureDetector extends AbstractPolicy {
    ...
    public static final ConfigKey<Sensor<HASensors.FailureDescriptor>> SENSOR_FAILED = ConfigKeys.newConfigKey(new TypeToken<Sensor<HASensors.FailureDescriptor>>() {},
            "failureDetector.sensor.fail", "A sensor which will indicate failure when set", HASensors.ENTITY_FAILED);

    @SuppressWarnings("serial")
    public static final ConfigKey<Sensor<HASensors.FailureDescriptor>> SENSOR_RECOVERED = ConfigKeys.newConfigKey(new TypeToken<Sensor<HASensors.FailureDescriptor>>() {},
