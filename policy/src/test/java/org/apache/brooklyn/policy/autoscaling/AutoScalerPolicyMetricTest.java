...
public class AutoScalerPolicyMetricTest {
    ...
    public void testIncrementsSizeIffUpperBoundExceeded() {
        ...
        Asserts.succeedsContinually(ImmutableMap.of("timeout", SHORT_WAIT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 1));

        tc.setAttribute(MY_ATTRIBUTE, 101);
        Asserts.succeedsEventually(ImmutableMap.of("timeout", TIMEOUT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 2));
    }
    ...
    public void testDecrementsSizeIffLowerBoundExceeded() {
        ...
        Asserts.succeedsContinually(ImmutableMap.of("timeout", SHORT_WAIT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 2));

        tc.setAttribute(MY_ATTRIBUTE, 49);
        Asserts.succeedsEventually(ImmutableMap.of("timeout", TIMEOUT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 1));
    }
    ...
    public void testIncrementsSizeInProportionToMetric() {
        ...
        Asserts.succeedsEventually(ImmutableMap.of("timeout", TIMEOUT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 10));
        
        // workload 5, requires 1 entity: (10*110)/100 = 11
        tc.setAttribute(MY_ATTRIBUTE, 110);
        Asserts.succeedsEventually(ImmutableMap.of("timeout", TIMEOUT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 11));
    }
    ...
    public void testDecrementsSizeInProportionToMetric() {
        ...
        tc.setAttribute(MY_ATTRIBUTE, 49);
        Asserts.succeedsEventually(ImmutableMap.of("timeout", TIMEOUT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 4));
    ...
    public void testObeysMinAndMaxSize() {
        ...
        Asserts.succeedsEventually(ImmutableMap.of("timeout", TIMEOUT_MS), AutoScalerPolicyTest.currentSizeAsserter(tc, 6));
    }
    ...
    public void testWarnsWhenMaxCapReached() {
        ...
        AutoScalerPolicyTest.currentSizeAsserter(tc, 6).run();
    }
