 ...
 * under the License.
 */
package org.apache.brooklyn.policy.basic;
...
public class PolicyConfigTest extends BrooklynAppUnitTestSupport {
    ...
    public void testConfigFlagsPassedInAtConstructionIsAvailable() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy(MutableMap.builder()
                .put("strKey", "aval")
                .put("intKey", 2)
                .build());
        app.addPolicy(policy);
        
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY), "aval");
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.INT_KEY), (Integer)2);
        // this is set, because key name matches annotation on STR_KEY
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY_WITH_DEFAULT), "aval");
    }
    ...
    public void testConfigPassedInAtConstructionIsAvailable() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy(MutableMap.builder()
                .put(BasicPolicyTest.MyPolicy.STR_KEY, "aval")
                .put(BasicPolicyTest.MyPolicy.INT_KEY, 2)
                .build());
        app.addPolicy(policy);
        ...
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY_WITH_DEFAULT), BasicPolicyTest.MyPolicy.STR_KEY_WITH_DEFAULT.getDefaultValue());
    }
    
    @Test
    public void testConfigSetToGroovyTruthFalseIsAvailable() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy(MutableMap.builder()
                .put(BasicPolicyTest.MyPolicy.INT_KEY_WITH_DEFAULT, 0)
                .build());
        app.addPolicy(policy);
        
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.INT_KEY_WITH_DEFAULT), (Integer)0);
    }
    
    @Test
    public void testConfigSetToNullIsAvailable() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy(MutableMap.builder()
                .put(BasicPolicyTest.MyPolicy.STR_KEY_WITH_DEFAULT, null)
                .build());
        app.addPolicy(policy);
        
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY_WITH_DEFAULT), null);
    }
    
    @Test
    public void testConfigCanBeSetOnPolicy() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy();
        policy.config().set(BasicPolicyTest.MyPolicy.STR_KEY, "aval");
        policy.config().set(BasicPolicyTest.MyPolicy.INT_KEY, 2);
        app.addPolicy(policy);
    ...
    public void testConfigSetterOverridesConstructorValue() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy(MutableMap.builder()
                .put(BasicPolicyTest.MyPolicy.STR_KEY, "aval")
                .build());
        policy.config().set(BasicPolicyTest.MyPolicy.STR_KEY, "diffval");
        app.addPolicy(policy);
        
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY), "diffval");
    }

    @Test
    public void testConfigCannotBeSetAfterApplicationIsStarted() throws Exception {
        BasicPolicyTest.MyPolicy policy = new BasicPolicyTest.MyPolicy(MutableMap.builder()
                .put(BasicPolicyTest.MyPolicy.STR_KEY, "origval")
                .build());
        app.addPolicy(policy);
        
        try {
            policy.config().set(BasicPolicyTest.MyPolicy.STR_KEY,"newval");
            fail();
        } catch (UnsupportedOperationException e) {
            // success
        }
        
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY), "origval");
    }
    ...
    public void testConfigReturnsDefaultValueIfNotSet() throws Exception {
        ...
        assertEquals(policy.getConfig(BasicPolicyTest.MyPolicy.STR_KEY_WITH_DEFAULT), "str key default");
    }
